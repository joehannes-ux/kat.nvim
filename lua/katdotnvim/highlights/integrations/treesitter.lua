...
do end (_2amodule_2a)["stringColor"] = stringColor
local function init()
  ...
  ucolors.highlight("TSMethod", ucolors.saturation(ucolors.brighten(ucolors.blendColors(syntax.identifier(), (colors.init("normalColors")).red, 0.3), 0.1), 0.1), "SKIP", "bold")
